...
Función asignarAContadores(valorIngresado,contadorPrimeraDecena Por Referencia,contadorSegundaDecena Por Referencia,contadorTerceraDecena Por Referencia)
...
Función mostrarPorcentajes (totalIteraciones,contadorPrimeraDecena,contadorSegundaDecena,contadorTerceraDecena)
